...
public class OrderServiceImp extends ServiceImpl<OrderMapper, Order> implements OrderService {
    ...
    // 订单已确认，生成
    @Override
    public void generateOrder(Long userId, OrderGenerateVo generateVo) throws RemotingException, InterruptedException, MQClientException {
        //生成订单号
        ...
        orderDetails.setGoodsId(generateVo.getGoods().getGoodsId());
        ...
        orderDetails.setGoodsName(generateVo.getGoods().getName());
