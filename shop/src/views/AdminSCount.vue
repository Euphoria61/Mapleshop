  ...
  <div class="Echarts">
    <el-tabs v-model="activeName" class="demo-tabs" style="margin-left:20px" @tab-click="handleClick">
      <el-tab-pane label="商品分类" name="first">
        <div style="flex: 1">
          <span style="margin-left:10px">请选择月份：</span>
          <el-date-picker
              v-model="year"
              placeholder="选择月份"
              type="month"
        ...
        <div id="main" style="width: 1200px; height: 500px; flex: 1;margin-top:20px"></div>
      </el-tab-pane>
      ...
      <el-tab-pane label="指定商品" name="third">
        <el-button plain type="primary" @click="dialog =true">更换商品</el-button>
        <div
            id="main2"
