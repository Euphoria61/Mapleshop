<template>
  <div>
    ...
    <svg class="icon" height="100" p-id="3885" style="margin-left:700px;margin-top:50px" t="1648185146158"
         version="1.1" viewBox="0 0 1870 1024" width="100" xmlns="http://www.w3.org/2000/svg">
      <path
